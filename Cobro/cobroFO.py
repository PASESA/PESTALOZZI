...
nombre_estacionamiento = 'Pestalozzi 1166'
...
class FormularioOperacion:
    ...
    def consulta_por_folio(self):
        ...
        self.frame_promociones.grid(column=0, row=1, padx=4, pady=4)

        self.frame_promociones_botones = Frame(self.frame_promociones)
        self.frame_promociones_botones.grid(column=0, row=0, padx=4, pady=4)
        ...
        self.button_promo_STARBUCKS.grid(column=0, row=0, padx=4, pady=4, sticky=tk.NSEW)
        # Botón "Promo LOCALES"
        ...
        self.button_promo_LOCALES.grid(column=1, row=0, padx=4, pady=4, sticky=tk.NSEW)

        self.labelpromo=ttk.LabelFrame(self.frame_promociones, text="Leer el QR de Promocion")
        self.labelpromo.grid(column=0, row=1, padx=4, pady=4, sticky=tk.NSEW)
